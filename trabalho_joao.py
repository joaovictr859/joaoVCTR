...
for i,arq in enumerate(arquivos):
    ...
    if verificar == True: #Arquivo Existe
        ...
        if not(id_produto in cardapio): 
            ...
            if not(salvar_interno):
                if not(atualizar('cardapio_dados.dat',cardapio)):
                    ...
                    salvar_interno = True
                    break
            print("\033[1;32mCADASTRO COM SUCESSO!\033[m")
        else:
            print(f'ID do produto já existe, corresponde a {cardapio[id_produto]["nome_exibicao"]}, tente novamente')

        print('\033[1;33mAGUARDANDO O RETORNO\033[m')
        sleep(3)
        ...
        while resp_caixa != '3':
            ...
            if resp_caixa == '1': #cadastrar
                ...
                if not(cpf in login):
                    ...
                    print(f'CPF Encontrado do cliente: {login[cpf]["nome"]}')
                    ...
                    print('======= DIGITE 0 PARA PARAR =======')
                    while prod != '0': 
                        prod = input(f'Insira o ID do {cont}° produto que deseja comprar: ')
                        if (prod in cardapio): 
                            total += cardapio[prod]['preco']
                            id_produtos.append(prod)
                            cont += 1
                        elif prod != '0': #Diferente do comando para sair
                            print('\033[1;33mID DE PRODUTO não identificado no cardápio\033[m') 

                    print('\033[1;32mPRODUTOS COMPRADOS COM SUCESSO!\033[m')
                ...
                if (nota in fiscal):
                    ...
                    print("============================================")
                    print(f"ID DOS PRODUTOS | {papel['id_produtos']}")
                    print(f"TOTAL           | R${papel['total']:.02f}")
